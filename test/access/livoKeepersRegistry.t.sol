...
contract LivoKeepersRegistryTest is Test {
    LivoKeepersRegistry internal registry;
    ...
    function setUp() public {
        registry = new LivoKeepersRegistry(owner);
    }
    ...
    function test_aStrangerCannotAppointKeepers() public {
        vm.prank(stranger);
        vm.expectRevert(LivoKeepersRegistry.NotAdmin.selector);
