...
interface IRealmFactory {
    ...
    ///         Both clocks start at token creation (see `RealmCreatorVault`); claims are additionally
    ...
    ///         `RealmTaxableToken.DividendsRequirePayoutConfig`.
