...
/// @title LivoKeepersRegistry
/// @notice The set of addresses allowed to trigger a Livo token's out-of-band earnings conversions —
...
///
/// @dev NOT UPGRADEABLE, and not behind a proxy, unlike `LivoDividendSwapRegistry`. That one is a proxy
...
contract LivoKeepersRegistry is Ownable2Step, ILivoKeepersRegistry {
    ...
    /// @inheritdoc ILivoKeepersRegistry
