...
contract RealmTaxableTokenUniV2 is RealmTaxableTokenUniV2Base {
    ...
    /// @notice Creates a new RealmTaxableTokenUniV2 instance which will be used as implementation for clones
    ...
    function _update(address from, address to, uint256 amount) internal virtual override {
        ...
        // `RealmToken`, so this is a single SLOAD; the locals also let the buy/sell branches
